...
{e=5,f=6}]"
        ...
        [Fact]
        public void CanCastValuesToPrimitives()
        {
            var hocon = @"{
  root : {
    bool : true
...
#pragma warning disable 618
            ...
            Assert.Equal("foo", config["root.quoted-string"].GetString());
            Assert.Equal("bar", config["root.unquoted-string"].GetString());
            Assert.Equal("foo bar", config["root.concat-string"].GetString());
            ...
            Assert.True(new[] {'f', 'o', 'o'}.SequenceEqual(config["root.string"].GetCharList()));
            ...
            Assert.True(new byte[] {1, 2, 3}.SequenceEqual(config["root.array"].GetByteList()));
            ...
            Assert.True(new[] {1, 2, 3}.SequenceEqual(config["root.array"].GetIntList()));
            ...
            Assert.True(new uint[] {1, 2, 3}.SequenceEqual(config["root.array"].GetUIntList()));
            ...
            Assert.True(new ushort[] {1, 2, 3}.SequenceEqual(config["root.array"].GetUShortList()));
            ...
            Assert.True(new[] {1, 2, 3, 4}.SequenceEqual(config["root.array-newline-element"].GetIntList()));
            Assert.True(new[] {"1 2 3 4"}.SequenceEqual(config["root.array-single-element"].GetStringList()));
            ...
            Assert.True(new float[] {1, 2, 3}.SequenceEqual(config["root.float-array"].GetFloatList()));
            ...
            Assert.True(new double[] {1, 2, 3}.SequenceEqual(config["root.float-array"].GetDoubleList()));
            ...
            Assert.True(new decimal[] {1, 2, 3}.SequenceEqual(config["root.float-array"].GetDecimalList()));
            ...
            Assert.True(new[] {"foo", "bar", "baz"}.SequenceEqual(config["root.string-array"].GetStringList()));
            ...
            Assert.True(new[] {1, 2}.SequenceEqual(config["root.array-array"][0].GetIntList()));
            Assert.True(new[] {3, 4}.SequenceEqual(config["root.array-array"][1].GetIntList()));
