...
namespace Hocon
{
    ...
    /// </summary>
    public interface IInternalHoconElement : IEquatable<IInternalHoconElement>
    {
        IInternalHoconElement Parent { get; }
        ...
        List<InternalHoconValue> GetArray();

        /// <summary>
        ///     Do deep copy of this element.
        /// </summary>
        /// <returns>A deep company of this element.</returns>
        IInternalHoconElement Clone(IInternalHoconElement newParent);
