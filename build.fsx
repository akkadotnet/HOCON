...
let signingName = "HOCON"
let signingDescription = "HOCON Configuration Library"
let signingUrl = "https://github.com/akkadotnet/hocon"
...
Target "NBench" <| fun _ ->
    let projects = 
        ...
        | _ -> !! "./src/**/*.Tests.Performance.csproj"
                   -- "./src/**/Hocon.Configuration.Tests.csproj" // skip on Linux
